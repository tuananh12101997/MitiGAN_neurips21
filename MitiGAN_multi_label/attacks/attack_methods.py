from attacks.class_spsa import *
...
class PGD:
    # def __init__(self, model, normalizer, alpha=0.05, epsilon=0.2, iters=100):  # MNIST
    # def __init__(self, model, normalizer, alpha=0.01, epsilon=0.05, iters=20):  # CIFAR10
    #def __init__(self, model,normalizer, alpha=0.01, epsilon=0.02, iters=20): #GTRSB 
    def __init__(self, model, normalizer, alpha=0.01, epsilon=0.3, iters=20):  # TinyImageNet
        self.model = model
        self.alpha = alpha
        self.epsilon = epsilon
        self.iters = iters
...
class BPDA:
    # def __init__(self, model, normalizer, max_iter=200, step_size=0.5, epsilon=0.2, linf=False):  # MNIST
    ...
    # def __init__(self, model, normalizer, max_iter=100, step_size=0.5, epsilon=0.01, linf=False):  # TinyImageNet
...
class SPSA:
    # def __init__(self, model, eps=0.4, delta=0.01, lr=0.02, nb_iter=160, nb_sample=128, max_batch_size=8):  # MNIST
    # def __init__(self, model, eps=0.2, delta=0.01, lr=0.01, nb_iter=10, nb_sample=128, max_batch_size=16): # CIFAR10
    # def __init__(self, model, eps=0.3, delta=0.001, lr=0.01, nb_iter=20, nb_sample=32, max_batch_size=1): # GTSRB
    def __init__(self, model, eps=0.2, delta=0.1, lr=0.05, nb_iter=30, nb_sample=8, max_batch_size=1): # TinyImageNet     
        self.model = model
        self.eps = eps
        self.delta = delta
        self.lr = lr
...
class MIFGSM:
    # def __init__(self, model, eps=0.2, steps=8, decay=1.0, alpha=0.1):  # MNIST
    def __init__(self, model, eps=0.01, steps=8, decay=1.0, alpha=0.01): # CIFAR10
    # def __init__(self, model, eps=0.02, steps=8, decay=1.0, alpha=0.01): # GTSRB
    # def __init__(self, model, eps=0.015, steps=8, decay=1.0, alpha=0.01): # TinyImageNet
        self.eps = eps
        self.steps = steps
        self.decay = decay
        self.alpha = alpha
...
class CW:
    ...
    # def __init__(self, model, c=1e-3, kappa=0, steps=300, lr=0.01):    # CIFAR10
    # def __init__(self, model, c=1e-1, kappa=0, steps=500, lr=0.01):  # GTSRB
    def __init__(self, model, c=1e-3, kappa=0, steps=100, lr=0.05):    # TinyImageNet
        self.c = c
        self.kappa = kappa
        self.steps = steps
        self.lr = lr
...
class ElasticNet:
    ...
    # def __init__(self, model, c=1e-1, kappa=0, steps=200, lr=0.05, alpha=1e-3):    # GTSRB
